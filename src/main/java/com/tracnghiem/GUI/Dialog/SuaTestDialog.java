 ...
 * @author THELUC
 */
public class SuaTestDialog extends javax.swing.JDialog {

    /**
     * Creates new form SuaTestDialog
     */
    public SuaTestDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SuaTestDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                SuaTestDialog dialog = new SuaTestDialog(new javax.swing.JFrame(), true);
